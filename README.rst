...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -0.644 --size=300x200 --depth=25 --zoom=0.6 --show
...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -0.7 +0.27015 j --size=500x300 --depth=512 --zoom=0.6 --show
...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -0.7102 +0.2698 j --size=500x300 --depth=512 --zoom=0.65 --show
...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -0.8 +0.156 j --size=400x230 --depth=50 --zoom=0.65 --show
...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -0.8 +0.156 j --size=500x300 --depth=512 --zoom=0.6 --show
...
#. Julia fractal
   ...
   ::
     ...
     $ python fractals.py julia -1.037 +0.17 j --size=600x300 --depth=40 --zoom=0.55 --show
...
#. Mandelbrot fractal
   ...
   ::
     ...
     $ python fractals.py mandelbrot --size=300x300 --depth=80 --zoom=1.2 --center=-1x0 --show
...
#. Mandelbrot fractal
   ...
   ::
     ...
     $ python fractals.py mandelbrot --size=400x300 --depth=80 --zoom=2 --center=-1x0 --show
...
#. Mandelbrot fractal
   ...
   ::
     ...
     $ python fractals.py mandelbrot --size=500x500 --depth=256 --zoom=6.5 --center=-1.2x0.35 --show
...
#. Mandelbrot fractal
   ...
   ::
     ...
     $ python fractals.py mandelbrot --size=500x500 --depth=80 --zoom=0.8 --center=-0.75x0 --show
...
#. Mandelbrot fractal
   ...
   ::
     ...
     $ python fractals.py mandelbrot --size=600x600 --depth=256 --zoom=90 --center=-1.255x0.38 --show
